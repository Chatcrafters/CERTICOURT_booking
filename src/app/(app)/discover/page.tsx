...
import { IconSearch, IconPin, IconCheck } from '@/components/icons'
    ...
    <div>
      <div className="bg-white px-5 pt-14 pb-4 border-b border-gray-100">
        ...
        <div className="flex items-center gap-3 bg-gray-50 rounded-xl px-4 py-3 border border-gray-200">
          <span className="text-gray-400"><IconSearch size={18} /></span>
        ...
        {centers?.map(center => (
          <Link key={center.id} href={`/book?center=${center.slug}`} className="flex items-center gap-3 p-4 bg-white active:bg-gray-50 transition-colors">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-xs text-gray-500 mt-0.5 flex items-center gap-1"><IconPin size={12} /> {center.city}, {center.country}</div>
              <div className="flex items-center gap-2 mt-1">
                {center.wpc_certified && <span className="text-xs bg-cc-blue/10 text-cc-blue font-semibold px-2 py-0.5 rounded-full font-mono inline-flex items-center gap-1">WPC <IconCheck size={12} /></span>}
